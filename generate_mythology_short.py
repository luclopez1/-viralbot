...
def assemble_mythology_video(
    ...
    subtitle_style = (
        "FontName=Liberation Sans,FontSize=55,PrimaryColour=&H00FFFFFF,"
        "Bold=1,OutlineColour=&H00000000,Outline=3,Shadow=2,"
        "Alignment=2,MarginL=60,MarginR=60,MarginV=150,WrapStyle=1"
    )
